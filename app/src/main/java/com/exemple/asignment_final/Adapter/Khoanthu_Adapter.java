...
import com.exemple.asignment_final.DiaLog.Bottom_sheet_edit_thu;
...
public class Khoanthu_Adapter extends RecyclerView.Adapter<Khoanthu_Adapter.MyViewHolder> {
                ...
                builder1.setPositiveButton(
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                giaodich_dao.delete(ds_thu.get(position).getMaLoai());
    ...
    public void capnhat(){
        ...
        Tab_Thu.khoanthu_adapter = new Khoanthu_Adapter(ds_thu,context);
