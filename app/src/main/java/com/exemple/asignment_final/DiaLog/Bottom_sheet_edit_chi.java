...
public class Bottom_sheet_edit_chi extends BottomSheetDialogFragment {
   ...
   @Nullable
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       ds_loai_thu = giaoDichDao.getChi();
    ...
    public void capnhat(){
        ...
        Tab_Chi.ds_khoanchi = giaoDichDao.getKhoanThu_Chi("Chi");
        Tab_Chi.khoanchi_adapter =new Khoanchi_Adapter(Tab_Chi.ds_khoanchi,getContext());
