...
import com.exemple.asignment_final.Adapter.Khoanthu_Adapter;
...
public class Bottom_sheet_edit_thu extends BottomSheetDialogFragment {
   ...
   @Nullable
    ...
    public void capnhat(){
        ...
        Tab_Thu.ds_khoanthu = giaoDichDao.getKhoanThu_Chi("Thu");
        Tab_Thu.khoanthu_adapter = new Khoanthu_Adapter(Tab_Thu.ds_khoanthu,getContext());
        Tab_Thu.rv_tthu.setAdapter(Tab_Thu.khoanthu_adapter);
    }
