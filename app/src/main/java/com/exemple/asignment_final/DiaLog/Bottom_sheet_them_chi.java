...
import com.exemple.asignment_final.Adapter.Adapter_sp_thu;
import com.exemple.asignment_final.Adapter.Khoanchi_Adapter;
import com.exemple.asignment_final.Dao.GiaoDichDao;
import com.exemple.asignment_final.Model.GiaoDich;
...
public class Bottom_sheet_them_chi extends BottomSheetDialogFragment {
    ...
    ArrayList<Phanloai> ds_loai_chi;
    ArrayList<GiaoDich> ds_khoanchi;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       ds_loai_chi = new ArrayList<>();

        ds_loai_chi = giaodich_dao.getChi();
       adapterSpThu = new Adapter_sp_thu(ds_loai_chi,getContext());
       ...
       tv_ngay.setOnClickListener(new View.OnClickListener() {
        ...
        btn_them_giaodich.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int Maloai = ds_loai_chi.get(index).getId_pl();
    ...
    public void capnhat(){
        ...
        Tab_Chi.khoanchi_adapter =new Khoanchi_Adapter(ds_khoanchi,getContext());
        Tab_Chi.rv_chi.setAdapter(Tab_Chi.khoanchi_adapter);
    }
}
